...
// ─── Brand Identity ───────────────────────────────────────────────────────────
export const BRAND_NAME       = "Martinico and";          // e.g. "AirPro"
export const BRAND_FULL_NAME  = "Martinico and Sons - Heating & Air Conditioning/hvac";           // e.g. "AirPro Heating & Air Conditioning"
export const BRAND_LEGAL_NAME = "Martinico and Sons - Heating & Air Conditioning/hvac";          // e.g. "AirPro Heating & Air Conditioning, Inc."
...
export const BRAND_INITIALS   = "MSH";             // e.g. "AP" — used in decorative elements

// ─── Contact ──────────────────────────────────────────────────────────────────
export const PHONE_LABEL  = "(408) 508-5414";   // e.g. "(408) 898-6999"
export const PHONE_TEL    = "tel:14085085414";  // e.g. "tel:14088986999"
export const BRAND_EMAIL  = "accounting@martinicoandsons.com";                    // e.g. "info@airpro.com"
export const BRAND_ADDRESS = "1776 S 7th St, San Jose, CA 95112";                 // e.g. "1593 Trieste Way, San Jose, CA 95122"
...
export const PRIMARY_COLOR   = "#600000";   // brand accent — buttons, links, gold
...
export const SEO_TITLE       = "Martinico and Sons - Heating & Air Conditioning/hvac — San Jose HVAC";
export const SEO_DESCRIPTION = "Martinico and Sons - Heating & Air Conditioning/hvac — San Jose's trusted HVAC professionals. Professional HVAC Service & Repair in San Jose.";
...
export const HERO_CTA_SECONDARY = "Call 408) 508-5414";   // patched to PHONE_LABEL
export const HERO_SIDE_RAIL_TEXT = "Serving Santa Clara County";
export const HERO_IMG_ALT       = "Martinico and Sons - Heating & Air Conditioning/hvac technician servicing a residential HVAC system in San Jose";
...
export const TRUST_PILLARS = [
  ...
  {
    num: "04",
    eyebrow: "The Martinico and Promise",
...
export const TESTIMONIALS = [
  ...
  {
    quote: "I've used several HVAC companies over the years, but Martinico and is by far the best. New system installed, whole process was smooth from start to finish. Clean work, fair price.",
    author: "Jennifer L.",
    role: "Google Review · 5★",
  },
  {
...
export const FAQ_ITEMS = [
  {
    ...
    a: `Yes — Martinico and Sons - Heating & Air Conditioning/hvac has been proudly serving the area for years. Most appointments are booked the same week you call, and our service call department is open Monday through Friday, 8:00 AM – 5:00 PM.`,
  },
  {
    q: "Are you licensed, bonded, and insured?",
    a: `Absolutely. Martinico and Sons - Heating & Air Conditioning/hvac is fully licensed, bonded, and insured. Every technician on our team is trained, professional, and treats your home with respect.`,
  },
  {
  ...
  },
  {
    ...
    a: "We provide Home Comfort System Installations, Commercial HVAC installations and design builds, HVAC Repair Services, Residential and Commercial Preventative Maintenance, Commercial Ventilation, Stainless Steel… — for both residential and…",
  },
  {
